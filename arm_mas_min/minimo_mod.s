...
_start:
    ...
    // Calcular el valor mínimo en el CSV
    mov x20, #0x7FFFFFFFFFFFFFFF // Inicializar x20 con el valor máximo de un entero
    ldr x1, =buffer             // Dirección del buffer en x1
...
parse_number:
    ...
    cmp x0, x20                 // Comparar x0 con x20
    csel x20, x0, x20, lt       // Si x0 < x20, actualizar x20 con x0
...
parse_end:
    ...
    mov x0, x20                 // Pasa el mínimo a x0
    ldr x1, =buffer             // Dirección del buffer en x1
